            ...
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    ...
                    <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
                        ...
                        <li>
                            <a href="index_t.php" class="nav-link text-white">
                            ...
                            <form action="pagar.php" method="post">
                                <div class="alert alert-success">
                                    <div class="form-group">
                                        ...
                                        <input id="nombre_Cliente" name="nombre_Cliente" class="form-control" type="text" placeholder="Escribe El nombre del cliente" required>
                                        <label for="my-input">direccion de contacto</label>
                                        <input id="direccion" name="direccion" class="form-control" type="text" placeholder="Escribe la direccion del cliente" required>
                                        <label for="my-input">Telefono de contacto</label>
                                        <input id="celular" name="celular" class="form-control" type="number" placeholder="Escribe El celular del cliente" required>
                                    </div>

                                </div>
                                <button class="btn btn-primary btn-lg btn-block" type="submit" name="btnAccion" value="proceder">Proceder a facturar >></button>
                            </form>
                        </td>
                    </tr>
                </tbody>
