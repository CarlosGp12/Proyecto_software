...
switch ($_POST['opcion']) {
    case 'consultar':
        ...
        foreach ($datos as $fila) {
            ...
            $tabla .= "<td>" . $fila['nombre_Proveedor'] . "</td>";
            $tabla .= "<td>" . $fila['direccion_Proveedor'] . "</td>";
    ...
    case 'ingresar':
        $datos['nombre_Proveedor'] = $_POST['nombre_Proveedor'];
        $datos['direccion_Proveedor'] = $_POST['direccion_Proveedor'];
