...
switch ($_POST['opcion']) {
    case 'consultar':
        ...
        foreach ($datos as $fila) {
            ...
            $tabla .= "<td>" . $fila['nombre_Cliente'] . "</td>";
            $tabla .= "<td>" . $fila['direccion_Cliente'] . "</td>";
    ...
    case 'ingresar':
        $datos['nombre_Cliente'] = $_POST['nombre_Cliente'];
        $datos['direccion_Cliente'] = $_POST['direccion_Cliente'];
